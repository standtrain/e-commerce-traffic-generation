...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间'
            ...
            $pdo->exec("INSERT INTO `settings` (`key`, `value`) VALUES ('site_name', ''), ('site_description', '精选优质商品，优惠多多'), ('site_icon', ''), ('background_image', ''), ('background_type', 'color'), ('footer_code', ''), ('custom_css', ''), ('ai_enabled', '0'), ('ai_api_url', ''), ('ai_api_key', ''), ('ai_model', 'gpt-3.5-turbo'), ('default_language', 'zh')");
